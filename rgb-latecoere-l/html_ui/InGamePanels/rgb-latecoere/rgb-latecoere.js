class IngamePanelCustomPanel extends TemplateElement {
    ...
    connectedCallback() {
		...
		setInterval(function() {
			...
			nav1DME_AltitudeDisplay = "null";
			nav1VOR_AltitudeDisplay = "null";
			nav1_AltitudeDisplay = "null";
			triangleSide_BC_KM_Display = "null";
			//
			...
			// de volgende gegevens weergeven op basis van condities.
			//
			if (nav1Code == 32) {
				if (nav1HasNav == 1) {
			...
			engMP_4_Display = engMP_4.toFixed(1);
			//
			engRPM_4 =
